...
<?php
function getData($id){
        $query = "select * from accesoires where id = ".$id;
...
<body>
    ...
    <section id="optique">
        <h1 class="section_title"> accesoires </h1>
        <div class="images">
            <ul>
            <li class="accesoire">
                   <div>
